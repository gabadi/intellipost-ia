...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_ml_credentials_user_id"), "ml_credentials", ["user_id"], unique=False)
    op.create_index(op.f("ix_ml_credentials_ml_user_id"), "ml_credentials", ["ml_user_id"], unique=False)
    op.create_index(op.f("ix_ml_credentials_ml_site_id"), "ml_credentials", ["ml_site_id"], unique=False)
    op.create_index(op.f("ix_ml_credentials_ml_expires_at"), "ml_credentials", ["ml_expires_at"], unique=False)
    op.create_index(op.f("ix_ml_credentials_ml_refresh_expires_at"), "ml_credentials", ["ml_refresh_expires_at"], unique=False)
    op.create_index(op.f("ix_ml_credentials_ml_is_valid"), "ml_credentials", ["ml_is_valid"], unique=False)
    
    # Ensure user can only have one ML credential set
    op.create_unique_constraint("uq_ml_credentials_user_id", "ml_credentials", ["user_id"])
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_ml_credentials_ml_refresh_expires_at"), table_name="ml_credentials")
