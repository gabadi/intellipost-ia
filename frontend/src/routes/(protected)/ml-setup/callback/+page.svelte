		...
		<div class="callback-card error">
					...
					<div class="error-content">
						<div class="error-explanation">
							...
							<p>
								...
								to complete this connection with a manager account.
							</p>
						</div>
			...
			{:else if isRateLimitError}
				...
				<div class="rate-limit-error">
					...
					<p>
						You've made too many connection attempts. Please wait before trying again.
					</p>
					{#if countdown > 0}
						<div class="countdown">
			...
			<div class="error-actions">
				...
				{:else}
					<button class="action-button primary" on:click={tryAgain}>
						Try Again
					</button>
				{/if}
