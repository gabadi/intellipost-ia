<script lang="ts">
	...
	function handleDisconnect() {
		...
		console.log('MercadoLibre account disconnected');
	}
	...
	function handleRefresh() {
		console.log('MercadoLibre connection status refreshed');
	}
</script>

<svelte:head>
	<title>MercadoLibre Setup - IntelliPost AI</title>
	<meta name="description" content="Connect your MercadoLibre account to automate product listing publishing with AI-generated content." />
</svelte:head>
		...
		<div class="header-content">
			<div class="header-text">
				...
				<p class="header-description">
					Connect your MercadoLibre account to automatically publish AI-generated 
					product listings and synchronize your inventory across platforms.
				</p>
			</div>
				...
				<div class="features-section">
					...
					<div class="features-grid">
						<div class="feature-card">
							...
							<p>
								Publish AI-generated product listings directly to your 
								MercadoLibre store with optimized titles and descriptions.
							</p>
						...
						<div class="feature-card">
							...
							<p>
								Keep your product inventory synchronized between 
								IntelliPost AI and MercadoLibre automatically.
							</p>
							<div class="feature-status enabled">
								<span class="status-indicator">✅</span>
								<span>Active</span>
						...
						<div class="feature-card">
							...
							<p>
								AI-powered optimization for better visibility and 
								conversion rates in MercadoLibre search results.
							</p>
							<div class="feature-status enabled">
								<span class="status-indicator">✅</span>
								<span>Active</span>
						...
						<div class="feature-card">
							...
							<p>
								Track listing performance and get insights on 
		...
		{:else}
			...
			<div class="not-connected-section">
					...
					<div class="benefits-list">
						<div class="benefit-item">
							...
							<div class="benefit-content">
								...
								<p>
									Generate high-quality product titles, descriptions, and categories 
									optimized for MercadoLibre's search algorithm.
								</p>
							</div>
						</div>
						...
						<div class="benefit-item">
							...
							<div class="benefit-content">
								<h3>Save Time</h3>
								<p>
									Automate the tedious process of creating and formatting 
									product listings. Focus on growing your business instead.
								</p>
							</div>
						</div>
						...
						<div class="benefit-item">
							...
							<div class="benefit-content">
								...
								<p>
									AI-optimized content helps your products rank higher 
									in search results and attract more buyers.
								</p>
							</div>
						</div>
						...
						<div class="benefit-item">
							...
							<div class="benefit-content">
								...
								<p>
									Keep your inventory up-to-date across all platforms 
				...
				<div class="connection-cta">
					...
					<p>
						Connect your MercadoLibre account now and start publishing 
						AI-generated listings in minutes.
					</p>
					...
					<div class="manager-notice">
						...
						<div class="notice-content">
							<p>
								<strong>Manager Account Required:</strong> Only MercadoLibre manager 
								accounts can connect to IntelliPost AI. Collaborator accounts 
								cannot authorize applications.
							</p>
						</div>
					</div>
					...
					<div class="security-note">
						<p>
							...
							credentials are never stored by IntelliPost AI.
						</p>
					</div>
				</div>
			</div>
...
<MLConnectionModal
	...
	bind:selectedSiteId={selectedSiteId}
