      ...
      <div class="modal-body">
          ...
          <div class="education-content">
            ...
            <div class="warning-section">
              <div class="warning-box">
                ...
                <div class="warning-content">
                  ...
                  <p>
                    <strong
                      >Only MercadoLibre manager accounts can connect to IntelliPost AI.</strong
                    >
            ...
            <div class="security-section">
              ...
              <p class="security-text">
                This connection uses OAuth 2.0 with PKCE security. Your MercadoLibre credentials are
                never stored by IntelliPost AI. You can revoke access at any time from your
                MercadoLibre account settings.
              </p>
            </div>
        ...
        {:else if currentStep === 'connecting'}
          ...
          <div class="connecting-content">
            ...
            <p>
              You will be redirected to MercadoLibre to authorize the connection. Please complete
              the authorization process there.
            </p>
