...
declare module "$env/static/private" {
  ...
  export const ADDI_MAIN_DB_MIGRATION_PATH: string;
  ...
  export const LOGS_HOME: string;
  export const JAVA_HOME: string;
  export const npm_lifecycle_event: string;
  export const EDITOR: string;
  export const OTEL_EXPORTER_OTLP_METRICS_TEMPORALITY_PREFERENCE: string;
  export const npm_package_name: string;
  export const ADDI_ENVIRONMENT: string;
  ...
  export const ADDI_REPOSITORY_LOCAL_ENVIRONMENT_PATH: string;
  ...
  export const npm_package_engines_python: string;
...
declare module "$env/dynamic/private" {
  export const env: {
    ...
    npm_execpath: string;
    ADDI_MAIN_DB_MIGRATION_PATH: string;
    ...
    NVM_BIN: string;
    BUN_INSTALL: string;
    ADDI_REPOSITORY_LOCAL_ENVIRONMENT_PATH: string;
    ...
    CLAUDECODE: string;
    npm_package_engines_python: string;
